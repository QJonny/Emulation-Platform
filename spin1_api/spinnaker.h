...
*  $HeadURL: https://solem.cs.man.ac.uk/svn/spin1_api/trunk/src/spinnaker.h $
*
* COPYRIGHT
...
#define DTCM_SIZE		0x00100000
#define DTCM_TOP		(DTCM_BASE + DTCM_SIZE)

#define SDRAM_BASE		0x70000000
//#define SDRAM_SIZE		(128 * 1024 * 1024) // 0x8000000
#define SDRAM_SIZE		0x08000000
#define SDRAM_TOP		(SDRAM_BASE + SDRAM_SIZE)

//#define SYSRAM_BASE 		0xf5000000 // change for the emulator to run on desktop machines
#define SYSRAM_BASE		0x1FFF8000


#ifdef TEST_CHIP
#define SYSRAM_SIZE 		0x00200000 // changed from 4000 for the emulator
#else
#define SYSRAM_SIZE 		0x00200000 // changed from 8000 for the emulator
#endif
...
#define DMA_BASE		0x00100000	// Unbuffered, changed for emulator
...
//#define RTR_BASE 		0xf1000000  // change for the emulator to run on 32-bit desktop machines
#define RTR_BASE 		0x1BFF8000
#define RTR_SIZE 		0x01000000 // added for emulator
...
#define SYSCTL_BASE		0xf2000000  // change for the emulator to run on 32-bit desktop machines
//#define SYSCTL_BASE		0x1CFF8000
//#define SYSCTL_SIZE		0x01000000 // MO - not sure how big this is supposed to be, doing enough for core locks atm (lock_try)
...
typedef struct iptag	// IPTAG entry (16 bytes)
{
  uchar ip[4];
  uchar mac[6];
  ushort port;
